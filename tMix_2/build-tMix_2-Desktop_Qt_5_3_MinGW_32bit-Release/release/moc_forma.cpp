...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FormA_t, stringdata) + ofs \
...
void FormA::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FormA *_t = static_cast<FormA *>(_o);
        switch (_id) {
        case 0: _t->closeProgramm(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject FormA::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FormA.data,
      qt_meta_data_FormA,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FormA.stringdata))
        return static_cast<void*>(const_cast< FormA*>(this));
