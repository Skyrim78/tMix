...
public:
    ...
    void setupUi(QWidget *operatorsM)
    {
        ...
        toolButton_delN->setMinimumSize(QSize(30, 30));
        toolButton_delN->setMaximumSize(QSize(30, 30));
        ...
        pushButton_del->setMinimumSize(QSize(100, 30));
        pushButton_del->setMaximumSize(QSize(100, 30));
        ...
        pushButton_prev->setMinimumSize(QSize(60, 30));
        pushButton_prev->setMaximumSize(QSize(60, 30));
        ...
        pushButton_next->setMinimumSize(QSize(60, 30));
        pushButton_next->setMaximumSize(QSize(60, 30));
        ...
        pushButton_save->setMaximumSize(QSize(100, 30));
    ...
    void retranslateUi(QWidget *operatorsM)
    {
        ...
        groupBox_operator->setTitle(QApplication::translate("operatorsM", "Operator", 0));
